...
export default class AbrirProjetos {
  constructor() {
    this.projetos = detalhesProjetos;
  ...
  init() {
    ...
    this.btnProximo.addEventListener("pointerdown", () => {
      if(this.indexProjeto === null) {
        this.passarManual(2);
      } else if(this.indexProjeto <= detalhesProjetos.length - 2) {
        this.indexProjeto++;
        this.passarManual(this.indexProjeto);
      } else if (this.indexProjeto >= detalhesProjetos.length - 1) {
        this.indexProjeto = 1;
        this.passarManual(this.indexProjeto);
      }
    });
    ...
    this.btnAnterior.addEventListener("pointerdown", () => {
      if(this.indexProjeto === null || this.indexProjeto === 0) {
        this.passarManual(detalhesProjetos.length - 1);
